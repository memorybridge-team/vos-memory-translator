...
- `extracted_text/sam2_iclr2025/`: SAM 2 논문의 페이지별 텍스트 44개
- `extracted_text/rds_cvpr2026/`: RDS 논문의 페이지별 텍스트 10개

추출문은 검색과 메모 작성 편의를 위한 보조 자료입니다. 수식, 표, 그림과 지면 배치는 원문 PDF를 기준으로 확인합니다.
